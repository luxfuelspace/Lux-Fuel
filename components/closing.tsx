    ...
    <section className="closing" id="closing">
      <div className="closing-orbital" aria-hidden="true">
        <svg viewBox="0 0 500 500" xmlns="http://www.w3.org/2000/svg">
          <circle cx="250" cy="250" r="220" fill="none" stroke="#3a8fd9" strokeWidth="1" strokeDasharray="2 8" opacity="0.3">
            <animateTransform attributeName="transform" type="rotate" from="0 250 250" to="360 250 250" dur="60s" repeatCount="indefinite" />
          </circle>
          <circle cx="250" cy="250" r="170" fill="none" stroke="#e63946" strokeWidth="1.5" strokeDasharray="6 8" opacity="0.5">
            <animateTransform attributeName="transform" type="rotate" from="0 250 250" to="-360 250 250" dur="40s" repeatCount="indefinite" />
          </circle>
          <circle cx="250" cy="250" r="120" fill="none" stroke="#3a8fd9" strokeWidth="1" strokeDasharray="3 5" opacity="0.45">
